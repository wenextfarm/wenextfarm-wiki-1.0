...
![genesis fixed raised bed](_images/fixed_raised_bed_fill_bed.png =700x)
![genesis xl fixed raised bed](_images/fixed_raised_bed_fill_bed_xl.png =700x)
...
![post hole diagram for farmbot genesis bed](_images/fixed_raised_bed_post_hole_diagram.png =700x)
![post holes for farmbot genesis bed](_images/fixed_raised_bed_post_holes_dug.png =700x)
![post hole diagram for farmbot genesis xl bed](_images/fixed_raised_bed_post_hole_diagram_xl.png =700x)
![post holes for farmbot genesis bed](_images/fixed_raised_bed_post_holes_dug_xl.png =700x)
...
![posts positioned genesis](_images/fixed_raised_bed_posts_positioned.png =700x)
![posts positioned genesis xl](_images/fixed_raised_bed_posts_positioned_xl.png =700x)
...
![drill short wall genesis](_images/fixed_raised_bed_drill_short_wall.png =700x)
![drill short wall genesis xl](_images/fixed_raised_bed_drill_short_wall_xl.png =700x)
...
![attach short wall genesis](_images/fixed_raised_bed_attach_short_wall.png =700x)
![attach short wall genesis xl](_images/fixed_raised_bed_attach_short_wall_xl.png =700x)

Repeat for the second **short wall** on the opposite side of the bed.

![second short wall genesis](_images/fixed_raised_bed_attach_second_short_wall.png =700x)
![second short wall genesis xl](_images/fixed_raised_bed_attach_second_short_wall_xl.png =700x)
...
![position the long walls for genesis](_images/fixed_raised_bed_position_long_walls.png =700x)
![position the long walls for genesis xl](_images/fixed_raised_bed_position_long_walls_xl.png =700x)
![position the long wall flush](_images/fixed_raised_bed_position_long_wall.png =700x)
![position the long walls for genesis xl](_images/fixed_raised_bed_position_long_walls_xl_2.png =700x)
...
![attach long wall for genesis](_images/fixed_raised_bed_attach_long_wall.png =700x)
![attach long walls for genesis xl](_images/fixed_raised_bed_attach_long_wall_xl.png =700x)

Repeat for the remaining **long wall(s)** on the opposite side of the bed.

![remaining long wall for genesis](_images/fixed_raised_bed_remaining_long_wall.png =700x)
![remaining long walls for genesis xl](_images/fixed_raised_bed_remaining_long_wall_xl.png =700x)
...
![tensioning cables](_images/fixed_raised_bed_tensioning_cables.jpg =700x)
![tensioning cables detail](_images/fixed_raised_bed_tensioning_cables_detail.jpg =700x)
...
![fill genesis bed](_images/fixed_raised_bed_fill_bed.png =700x)
![fill genesis xl bed](_images/fixed_raised_bed_fill_bed_xl.png =700x)
