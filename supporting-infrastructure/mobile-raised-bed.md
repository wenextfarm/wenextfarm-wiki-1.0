...
![mobile raised bed](_images/mobile_raised_bed.jpg =300)
...
![floor panels](_images/floor_panels.png =700px)
...
![floor panels with legs](_images/floor_panels_with_legs.png =700px)
...
![floor panel supports](_images/floor_panel_supports.png =700px)

Flip everything over and attach the supports to the panels using **30mm screws** spaced roughly every 150mm.

![floor panel support screws](_images/floor_panel_support_screws.png =700px)
...
![raised floor panel subassembly](_images/raised_floor_panel_subassembly.png =700px)

Now position one of the **short walls** against the short edge of the **floor panel** as shown.

![short wall and floor panel](_images/short_wall_and_floor_panel.png =700px)
...
![short wall screws](_images/short_wall_screws.png =700px)

Repeat for the second panel and second short wall.

![both floor panels and short walls](_images/both_floor_panels_and_short_walls.png =700px)
...
![first long wall attached](_images/first_long_wall_attached.png =700px)
...
![first long wall attached with screws](_images/first_long_wall_attached_with_screws.png =700px)

Repeat for the second long wall.

![both long walls attached](_images/both_long_walls_attached.png =700px)
...
![upside down](_images/upside_down.png =700px)

Position one of the **legs** in the corner of the bed.

![first leg](_images/first_leg.jpg =700px)
...
![leg bolt holes](_images/leg_bolt_holes.jpg =700px)
...
![leg attached with bolts](_images/leg_attached_with_bolts.jpg =700px)

Repeat for the remaining three **legs**.

![all legs attached](_images/all_legs_attached.jpg =700px)

# Step 8: Attach the casters

Using four **65mm screws**, attach a **caster** to the bottom of a **leg**.

![Caster](_images/caster.jpg =700px)

Repeat for the remaining three casters.

![Casters](_images/casters.jpg =700px)
...
![On Wheels](_images/on_wheels.jpg =700px)
...
![middle panel attached](_images/middle_panel_attached.jpg =700px)
...
![bed filled with soil](_images/bed_filled_with_soil.jpg =700px)
