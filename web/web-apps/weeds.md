...
published: true
date: 2026-07-13T06:06:30.161Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T07:56:48.357Z
---
...
![weeds panel](/web/web-apps/_images/weeds_panel.png =700x)
...
![add new weed](/web/web-apps/_images/add_new_weed.png =700x)
...
![weeds panel with weed hovered](/web/web-apps/_images/weeds_panel_with_weed_hovered.png =700x)
...
![edit weeds panel with move to weed button](/web/web-apps/_images/edit_weeds_panel_with_move_to_weed_button.png =700x)
...
![move to weed location step](/web/web-apps/_images/move_to_weed_location_step.png =700x)
