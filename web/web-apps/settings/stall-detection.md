...
published: true
date: 2026-07-13T06:51:14.059Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T07:56:36.452Z
---

> **ℹ️ For FarmBot Express bots only:** 
> 
> Stall detection settings are only available for FarmBot Express bots. FarmBot Genesis users should refer to the [encoders](encoders.md) section.
{.is-info}
...
> **⚠️ Recommended for the X and Y axes only:** 
> 
> Stall detection is not recommended for use with the Z-axis due to the high motor load associated with raising the Z-axis against gravity.
{.is-warning}
...
![motor load popup](/web/web-apps/settings/_images/motor_load_popup.png =700x)
...
![motor load plot](/web/web-apps/settings/_images/motor_load_plot.png =700x)
...
> **⚠️ Note:** 
> 
> Keep in mind that it is unreasonable to accelerate over an extremely short distance because the motors must bring the mass of the entire gantry up to speed. Accelerating _too quickly_ or having a minimum speed that is too high will cause abrupt changes in speed that will compromise accuracy.
{.is-warning}
