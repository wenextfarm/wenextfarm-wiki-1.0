...
---
> **⚠️ Note:** It is no longer recommended to create and manage pin bindings from the settings panel. Instead, use the [push button interface](../../app/controls/peripherals.md#push-buttons) found in the peripherals section of the controls panel.
...
![add stock pin binding](_images/pin_binding.gif =700px)
...
> **⚠️ Warning:** * Binding to a pin without a physical button and pull-down resistor connected may put FarmBot into an unstable state.
