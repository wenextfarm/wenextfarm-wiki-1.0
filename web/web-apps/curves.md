---
title: Curves
description: Define plant water needs and expected height and spread over time. [Open this panel in the app](https://my.farm.bot/app/designer/curves).
published: true
date: 2026-07-13T06:10:43.581Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T07:53:07.599Z
---
...
![curves](/web/web-apps/_images/curves.png =700x)
...
![add curve](/web/web-apps/_images/add_curve.png =700x)
...
![edit curve](/web/web-apps/_images/edit_curve.png =700x)
...
![final control point](/web/web-apps/_images/final_control_point.png =700x)
...
![curve templates](/web/web-apps/_images/curve_templates.png =700x)
...
![add and edit curve control points](/web/web-apps/_images/edit_curve.gif =700x)
...
![curve data table](/web/web-apps/_images/curve_data_table.png =700x)
...
![scale curve](/web/web-apps/_images/scale_curve.png =700x)
...
> **ℹ️ Note:** 
> 
> When adding new plants to your garden, the most-frequently used curves for that crop will be automatically selected and applied, which you may override if desired.
{.is-info}


![apply curve to plant](/web/web-apps/_images/apply_curve_to_plant.png =700x)
...
![curve spread warning](/web/web-apps/_images/curve_spread_warning.png =700x)
...
![curve height warning](/web/web-apps/_images/curve_height_warning.png =700x)
