...
published: true
date: 2026-07-13T06:16:19.604Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T08:04:10.629Z
---
...
![static sequence](/web/web-apps/sequences/_images/static_sequence.png =700x)
...
![add location variable](/web/web-apps/sequences/_images/add_location_variable.png =700x)

Name the variable "Tool" and then select the `Watering nozzle` for the location variable's value.

![select watering nozzle](/web/web-apps/sequences/_images/select_watering_nozzle.png =700x)
...
![choose the location variable](/web/web-apps/sequences/_images/choose_variable.png =700x)
...
![changing the location variable value](/web/web-apps/sequences/_images/changing_variable_value.gif =700x)
...
> **ℹ️ Optionally provide a default value:** 
> 
...
![dynamic sequence](/web/web-apps/sequences/_images/dynamic_sequence.png =700x)
