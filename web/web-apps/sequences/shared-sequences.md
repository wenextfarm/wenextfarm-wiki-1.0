...
published: true
date: 2026-07-13T06:20:29.600Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T08:03:57.669Z
---
...
> **ℹ️ Note:** 
> 
> Once a sequence has been published, you cannot edit the public copy. You can however [publish new versions](#publishing-new-versions) of the sequence, or [unpublish](#unpublishing) it entirely.
{.is-info}


![publish sequence](/web/web-apps/sequences/_images/publish_sequence.png =700x)
...
![published sequence](/web/web-apps/sequences/_images/published_sequence.png =700x)
...
> **ℹ️ Note:** 
> 
> When you publish a new version, other users of the sequence will see that you have published the new version and may optionally upgrade to it.
{.is-info}


![published new version](/web/web-apps/sequences/_images/publish_new_version.png =700x)
...
![unpublish sequence](/web/web-apps/sequences/_images/unpublish_sequence.png =700x)
...
![public sequence preview](/web/web-apps/sequences/_images/public_sequence_preview.png =700x)
...
![your copy and public copy tabs](/web/web-apps/sequences/_images/your_copy_public_copy.png =700x)
...
> **ℹ️ Note:** 
> 
> Always review the contents of a new version before upgrading to ensure that your FarmBot will continue to operate as expected after the upgrade.
{.is-info}


![upgrade to latest](/web/web-apps/sequences/_images/upgrade_to_latest.png =700x)
...
![public copy version picker](/web/web-apps/sequences/_images/public_copy_version_picker.png =700x)
