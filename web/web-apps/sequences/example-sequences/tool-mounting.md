...
---
> **ℹ️ Note:** This example sequence is only applicable to FarmBot Genesis kits, which have a universal tool mounting system and interchangeable tools.
...
![mount nozzle sequence empty](_images/mount_nozzle_sequence_empty.png =700px)
...
> **ℹ️ If you are not using encoders, endstops, or stall detection...:** You may use a <span class='fb-step fb-move-absolute'>Move</span> step to (0, 0, 0) instead of <span class='fb-step fb-find-home'>Find Home</span>.

![mount nozzle sequence find home](_images/mount_nozzle_sequence_find_home.png =700px)
...
![mount nozzle sequence move above](_images/mount_nozzle_sequence_move_above.png =700px)
...
![mount nozzle sequence move to](_images/mount_nozzle_sequence_move_to.png =700px)
...
![mount nozzle sequence move out](_images/mount_nozzle_sequence_move_out.png =700px)
...
> **✅ Your turn:** Now that you've created a tool mounting sequence, try creating a sequence to return the tool to the toolbay.
