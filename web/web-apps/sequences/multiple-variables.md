...
published: true
date: 2026-07-13T06:18:34.602Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T08:03:14.209Z
---
...
![add multiple variables](/web/web-apps/sequences/_images/add_multiple_variables.png =700x)
...
![remove variable](/web/web-apps/sequences/_images/remove_variable.png =700x)
...
![rename variable](/web/web-apps/sequences/_images/rename_variables.png =700x)
...
![multiple variable run button](/web/web-apps/sequences/_images/multiple_variable_run_button.png =700x)

> **⚠️ Only one group variable is allowed per sequence:** 
> 
