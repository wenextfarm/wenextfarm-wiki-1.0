...
> **ℹ️ Note:** New events must be scheduled at least one minute into the future.

> **⚠️ FarmBot performs updates at 3AM:** Avoid scheduling any events between 2AM and 4AM.

![events panel](_images/events_panel.png =700px)
...
![add new event panel](_images/add_new_event_panel.png =700px)
...
![events panel with events](_images/events_panel_with_events.png =700px)
...
> **⚠️ Some changes aren't allowed:** You cannot change from executing a sequence to executing a regimen or vice versa.

![edit event button](_images/edit_event_button.png =700px)
