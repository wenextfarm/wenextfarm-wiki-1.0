...
![sensors panel](/web/web-apps/_images/sensors_panel.png =700x)
...
![edit sensors](/web/web-apps/_images/edit_sensors.png =700x)
...
![read sensors](/web/web-apps/_images/read_sensors.png =700x)
...
![sensor reading history](/web/web-apps/_images/sensor_reading_history.png =700x)
...
![add manual sensor reading](/web/web-apps/_images/add_manual_sensor_reading.png =700x)
