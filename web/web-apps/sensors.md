...
> **ℹ️ Not shown for all bots:** If your FarmBot kit did not include any sensors (Express kits), then the sensors panel will not be shown in the app. You can override this using the **HIDE SENSORS** setting.

![sensors panel](_images/sensors_panel.png =700px)
...
![edit sensors](_images/edit_sensors.png =700px)
...
![read sensors](_images/read_sensors.png =700px)
...
![sensor reading history](_images/sensor_reading_history.png =700px)
...
![add manual sensor reading](_images/add_manual_sensor_reading.png =700px)
...
> **ℹ️ Note:** You cannot delete a sensor that is in-use by a sequence.
