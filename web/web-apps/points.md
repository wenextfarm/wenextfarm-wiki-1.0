...
![empty points panel](_images/empty_points_panel.png =700px)
...
![add new point](_images/add_new_point.png =700px)
...
![soil height points](_images/soil_height_points.png =700px)
...
![add point grid](_images/add_point_grid.png =700px)
...
![add point grid with camera fov](_images/add_point_grid_with_camera_fov.png =700px)
...
![points panel with point hovered](_images/points_panel_with_point_hovered.png =700px)
...
![edit point panel with move to button](_images/edit_point_panel_with_move_to_button.png =700px)
...
![move to point sequence step](_images/move_to_point_sequence_step.png =700px)
...
![point sort menu](_images/point_sort_menu.png =700px)
...
> **ℹ️ Note:** Points cannot be deleted if they are in-use by any sequences, regimens, or events.
