...
![empty points panel](/web/web-apps/_images/empty_points_panel.png =700x)
...
![add new point](/web/web-apps/_images/add_new_point.png =700x)
...
![soil height points](/web/web-apps/_images/soil_height_points.png =700x)
...
![add point grid](/web/web-apps/_images/add_point_grid.png =700x)
...
![add point grid with camera fov](/web/web-apps/_images/add_point_grid_with_camera_fov.png =700x)
...
![points panel with point hovered](/web/web-apps/_images/points_panel_with_point_hovered.png =700x)
...
![edit point panel with move to button](/web/web-apps/_images/edit_point_panel_with_move_to_button.png =700x)
...
![move to point sequence step](/web/web-apps/_images/move_to_point_sequence_step.png =700x)
...
![point sort menu](/web/web-apps/_images/point_sort_menu.png =700x)
