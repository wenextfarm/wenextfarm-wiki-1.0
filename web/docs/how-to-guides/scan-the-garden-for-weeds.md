...
> **✅ Note:** Use a unique color for these points - it will come in handy in the next step!


![point grid creation](_images/point_grid_creation.png =700px)
...
![point group creation](_images/point_group_creation.png =700px)
...
![detect weeds at point sequence](_images/detect_weeds_at_point_sequence.png =700px)
...
![scan entire garden for weeds sequence](_images/scan_entire_garden_for_weeds_sequence.png =700px)
...
![garden scan](_images/garden_scan.gif =700px)
