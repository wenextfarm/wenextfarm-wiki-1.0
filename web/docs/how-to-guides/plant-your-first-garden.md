...
> **✅ Tips:** * Do not place plants too closely together or they will fight each other for resources
* Do not place plants too close to the edges of your bed or any tool slots or they may interfere with FarmBot


![add plants](_images/add_plants.gif =700px)
...
![plants panel](_images/plants_panel.png =700px)


> **ℹ️ Note:** For more detailed instructions and advanced methods for adding plants to your map, [click here](../../app/plants.md).
...
![edit plants](_images/edit_plants.gif =700px)
...
![create group](_images/create_group.gif =700px)


> **ℹ️ Note:** For more detailed instructions and advanced methods for creating plants groups, [click here](../../app/groups.md).
...
> **ℹ️ Prerequisite:** This sequence assumes your FarmBot has a seeding needle attached to the tool head. For Genesis kits, this means FarmBot should have the seeder tool mounted on the UTM. For Express kits, this means you should have manually screwed a luer lock needle into the 3-in-1 tool head.
...
![move to seed trough step](_images/move_to_seed_trough_step.png =700px)

**Step 2:** <span class="fb-step fb-write-pin">CONTROL PERIPHERAL</span> to turn the vacuum pump **ON** for picking up a seed.

![turn vacuum on step](_images/turn_vacuum_on_step.png =700px)
...
![move into seed trough step](_images/move_into_seed_trough_step.png =700px)
...
![move out of seed trough step](_images/move_out_of_seed_trough_step.png =700px)
...
![externally defined location](_images/externally_defined_location.png =700px)


![move to externally defined location step](_images/move_to_externally_defined_location_step.png =700px)
...
![move to externally defined location with z offset](_images/move_to_externally_defined_location_with_z_offset.png =700px)
...
![turn vacuum off step](_images/turn_vacuum_off_step.png =700px)

**Step 8:** <span class="fb-step fb-mark-as">MARK AS</span> to **MARK** the location variable (the plant) **AS** `Planted`.

![mark as planted step](_images/mark_as_planted_step.png =700px)
...
![move needle out of soil step](_images/move_needle_out_of_soil_step.png =700px)


> **✅ Note:** Sequence 1 is now complete. Give it a descriptive name such as \
...
> **ℹ️ Note:** This step is only applicable for Genesis kits with a UTM and interchangeable tools.


![mount seeder step](_images/mount_seeder_step.png =700px)
...
![plant all spinach seeds step](_images/plant_all_spinach_seeds_step.png =700px)
...
![dismount seeder step](_images/dismount_seeder_step.png =700px)


> **✅ Note:** Sequence 2 is now complete. Give it a name and press <span class=\
