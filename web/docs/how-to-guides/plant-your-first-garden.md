...
published: true
date: 2026-07-13T05:31:02.180Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T07:14:44.918Z
---
...
> **Tips:** 
> 
> Do not place plants too closely together or they will fight each other for resources
{.is-success}

* Do not place plants too close to the edges of your bed or any tool slots or they may interfere with FarmBot


![add plants](/web/docs/how-to-guides/_images/add_plants.gif =700x)
...
![plants panel](/web/docs/how-to-guides/_images/plants_panel.png =700x)


**ℹ️ Note:** 

For more detailed instructions and advanced methods for adding plants to your map, [click here](../../app/plants.md).
...
![edit plants](/web/docs/how-to-guides/_images/edit_plants.gif =700x)
...
![create group](/web/docs/how-to-guides/_images/create_group.gif =700x)


**ℹ️ Note:** 

For more detailed instructions and advanced methods for creating plants groups, [click here](../../app/groups.md).

# Step 3: Create seeding sequences

In this tutorial we'll make two sequences. The first sequence will plant one seed for one plant. We'll then use this as a building block to plant all the seeds for one crop type in the second sequence. If you are unfamiliar with what sequences are, read the [sequences](../../app/sequences.md) documentation before beginning.

## Sequence 1: Plant one seed

> **Prerequisite:** 
> 
> This sequence assumes your FarmBot has a seeding needle attached to the tool head. For Genesis kits, this means FarmBot should have the seeder tool mounted on the UTM. For Express kits, this means you should have manually screwed a luer lock needle into the 3-in-1 tool head.
{.is-info}
...
![move to seed trough step](/web/docs/how-to-guides/_images/move_to_seed_trough_step.png =700x)

**Step 2:** <span class="fb-step fb-write-pin">CONTROL PERIPHERAL</span> to turn the vacuum pump **ON** for picking up a seed.

![turn vacuum on step](/web/docs/how-to-guides/_images/turn_vacuum_on_step.png =700x)
...
![move into seed trough step](/web/docs/how-to-guides/_images/move_into_seed_trough_step.png =700x)
...
![move out of seed trough step](/web/docs/how-to-guides/_images/move_out_of_seed_trough_step.png =700x)
...
![externally defined location](/web/docs/how-to-guides/_images/externally_defined_location.png =700x)


![move to externally defined location step](/web/docs/how-to-guides/_images/move_to_externally_defined_location_step.png =700x)
...
![move to externally defined location with z offset](/web/docs/how-to-guides/_images/move_to_externally_defined_location_with_z_offset.png =700x)
...
![turn vacuum off step](/web/docs/how-to-guides/_images/turn_vacuum_off_step.png =700x)

**Step 8:** <span class="fb-step fb-mark-as">MARK AS</span> to **MARK** the location variable (the plant) **AS** `Planted`.

![mark as planted step](/web/docs/how-to-guides/_images/mark_as_planted_step.png =700x)
...
![move needle out of soil step](/web/docs/how-to-guides/_images/move_needle_out_of_soil_step.png =700x)


> **✅ Note:** 
> 
> Sequence 1 is now complete. Give it a descriptive name such as \
{.is-success}
...
> **ℹ️ Note:** 
> 
> This step is only applicable for Genesis kits with a UTM and interchangeable tools.
{.is-info}



![mount seeder step](/web/docs/how-to-guides/_images/mount_seeder_step.png =700x)
...
![plant all spinach seeds step](/web/docs/how-to-guides/_images/plant_all_spinach_seeds_step.png =700x)
...
![dismount seeder step](/web/docs/how-to-guides/_images/dismount_seeder_step.png =700x)


**✅ Note:** 

Sequence 2 is now complete. Give it a name and press

# Step 4: Plant the seeds

You are now ready to try out your sequences and plant your first garden! Pour seeds into the gantry-mounted seed trough that you selected in Sequence 1 and place the trough in its holster. With Sequence 2 loaded into the sequence editor, press . FarmBot should now plant one seed for every plant in the group.

Once finished, you can add different seeds to the trough, select a different group of plants in Sequence 2,SAVE the sequence, and RUNit again!
