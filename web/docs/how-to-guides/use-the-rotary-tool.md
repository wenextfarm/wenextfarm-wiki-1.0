...
![rotary tool](_images/rotary_tool.png =700px)
...
> **ℹ️ Note:** Activating both Pin 2 and Pin 3 at the same time will result in the rotary tool not moving. While this will not cause any damage, it is not recommended.

![rotary tool manual control](_images/rotary_tool_manual_control.png =700px)
...
![rotary tool control peripheral](_images/rotary_tool_control_peripheral.png =700px)
![rotary tool toggle peripheral](_images/rotary_tool_toggle_peripheral.png =700px)
![rotary tool lua](_images/rotary_tool_lua.png =700px)
