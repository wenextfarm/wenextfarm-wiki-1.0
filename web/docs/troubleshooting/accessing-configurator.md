...
published: true
date: 2026-07-13T05:44:13.241Z
tags: v15
editor: markdown
dateCreated: 2026-07-10T07:15:31.389Z
---
...
> **Note:** 
> 
> Configurator will **not** start if you do not flash the microSD card using the special **Etcher** program. Always follow the [installation instructions](../../farmbot-os/intro.md) and do not skip steps.
{.is-warning}
...
> 
> FarmBot OS will not work with microSD cards larger than 32GB in capacity. Please use a microSD card 32GB or smaller. We recommend 8GB.
{.is-warning}
...
> **Using an off-grid power system?:** 
> 
> At this time we cannot provide support for off-grid power systems. If you are using an off-grid system and the Raspberry Pi is not receiving adequate power, please consult an electrician for additional help.
{.is-info}
...
> **Be patient:** 
> 
> It can take up to 2 minutes from turning on the power until when the FarmBot is broadcasting the network.
{.is-info}
