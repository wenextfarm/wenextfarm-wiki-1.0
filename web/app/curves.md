...
![curves](_images/curves.png =700px)
...
![add curve](_images/add_curve.png =700px)
...
![edit curve](_images/edit_curve.png =700px)
...
![final control point](_images/final_control_point.png =700px)
...
![curve templates](_images/curve_templates.png =700px)
...
![add and edit curve control points](_images/edit_curve.gif =700px)
...
![curve data table](_images/curve_data_table.png =700px)
...
![scale curve](_images/scale_curve.png =700px)
...
> **ℹ️ Note:** When adding new plants to your garden, the most-frequently used curves for that crop will be automatically selected and applied, which you may override if desired.

![apply curve to plant](_images/apply_curve_to_plant.png =700px)
...
![curve spread warning](_images/curve_spread_warning.png =700px)
...
![curve height warning](_images/curve_height_warning.png =700px)
