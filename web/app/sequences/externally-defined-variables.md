...
![run button variables](_images/run_button_variables.png =700px)
...
![execute with variable](_images/execute_with_variable.png =700px)
...
![pass variable value from parent to subsequences](_images/pass_variables.png =700px)

> **ℹ️ Russian doll sequences:** By setting the new variable in the parent sequence to `Externally defined`, you can create a set of \
...
![regimen variable form](_images/regimen_variable_form.png =700px)
...
![event variable form](_images/event_variable_form.png =700px)
...
![variable values in event instance](_images/variable_values_in_event.png =700px)
