...
![if statement](_images/if_statement.png =700px)
...
![mark as](_images/mark_as.png =700px)
...
![mark as custom property](_images/mark_as_custom_property.png =700px)
...
![send message](_images/send_message.png =700px)
...
![shutdown](_images/shutdown.png =700px)
