...
---
> **⚠️ Advanced features:** The commands listed on this page are intended for power users and software developers only.
...
![assertion](_images/assertion.png =700px)
...
> **ℹ️ Note:** See the [developer documentation](http://lua.farm.bot) for a list of available Lua functions.
...
![ai lua prompt](_images/lua_example_prompt.png =700px)
...
![ai lua generation](_images/lua_ai_generation.gif =700px)
...
> **ℹ️ Note:** By including the names and pin numbers of all your peripherals, sensors, and tools automatically, you can ask things like “Turn on the lights” and the AI will understand which pin number to operate.
...
![ai lua comments](_images/lua_ai_comments.png =700px)
