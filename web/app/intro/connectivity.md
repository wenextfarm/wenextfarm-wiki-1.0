...
> **ℹ️ Note:** Keep in mind that there may be a problem with your phone or laptop's connection and no issues with the FarmBot.
...
![connectivity](_images/connectivity.png =700px)
...
![metric history](_images/metric_history.png =700px)
