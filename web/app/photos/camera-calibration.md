...
![camera calibration card](_images/camera_calibration_card.jpg =700px)
...
![camera calibration setup](_images/camera_calibration_setup.png =700px)
...
> **ℹ️ Be patient:** This process may take up to 3 minutes to complete on FarmBot Express devices, and up to 2 minutes on FarmBot Genesis devices. Watch the status ticker for progress updates.
...
![overexposed calibration image](_images/overexposed_calibration_image.png =700px)
