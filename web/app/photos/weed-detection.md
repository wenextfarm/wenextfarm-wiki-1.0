...
> **ℹ️ Calibration required:** To use the weed detection feature, you must first [calibrate the camera](camera-calibration.md).
...
![weed detection color range inputs](_images/weed_detection_color_range_inputs.png =700px)
...
![weeds panel and weeds in map](_images/weeds_panel_and_weeds_in_map.png =700px)
...
![all plants detected as weeds](_images/all_plants_detected_as_weeds.jpg =700px)
...
![known plants detected plants and detected weeds](_images/known_plants_detected_plants_and_detected_weeds.jpg =700px)
...
![detected plants and weeder disruption circle](_images/detected_plants_and_weeder_disruption_circle.jpg =700px)
...
![detected plants and save remove weeds](_images/detected_plants_and_save_remove_weeds.jpg =700px)
...
![weed detection processing parameters](_images/weed_detection_processing_parameters.png =700px)
