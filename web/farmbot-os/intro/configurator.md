...
---
> **ℹ️ Configuration requires a web app account:** To complete configuration, you must have a **verified web app account**. See instructions for creating and verifying an account [here](../../app/intro/creating-an-account.md).
...
> **⚠️ Note:** Configurator will not run if you have not flashed the microSD card with [FarmBot OS](../intro.md).
...
> **ℹ️ If you don't see the captive portal or notification...:** Try navigating to [setup.farm.bot](http://setup.farm.bot) or [192.168.24.1](http://192.168.24.1) using your web browser.

> **⚠️ Turn off cellular data:** If you are using a smartphone you may need to disable cellular data to allow your phone's web browser to connect to the configurator.
...
> **ℹ️ Note:** If you need to know the **network interface name** and/or **MAC address**, press the <span class=\

![Network](_images/network.png =700px)
...
![wifi](_images/wifi.png =700px)

> **✅ Choose a WiFi network with good signal strength:** FarmBot will **NOT** work reliably if it is not receiving a strong WiFi signal from your wireless router. It is recommended you only select a WiFi network if it has *GOOD* (green) or *OK* (orange) **STRENGTH**. If the signal strength is too weak, you will not be allowed to select that network.
...
![wifi credentials](_images/wifi_credentials.png =700px)
...
![web app credentials](_images/web_app_credentials.png =700px)

> **ℹ️ Note:** If you are self-hosting the web application on your own servers, replace <span class=\
