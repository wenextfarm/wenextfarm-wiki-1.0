...
Using the web app, shutdown the FarmBot. Then unplug the [power supply](power supply) from the **power source**.
...
For XL sized devices, you will need an additional person to help with this step. Each person should be positioned near a [gantry column](gantry column) (one person on either side of the FarmBot). Pulling from the gantry columns, both people must work in unison to slowly slide the gantry off of the tracks.
