...
![illustration of farmbot with vines at the ends of the bed](_images/illustration_of_farmbot_with_vines_at_the_ends_of_the_bed.png =700px)
...
> **✅ Manage the growth:** For this technique to be successful, you must ensure that these crops grow out of the bed only along the X-axis. If they grow out of the bed along the Y-axis, the plants will interfere with the tracks and the FarmBot's ability to move along the full length of the X-axis.
