...
You can use a **USB-based OAK camera** in place of the stock FarmBot [camera](camera) if you are just looking for **higher resolution** images or a different **field of view**. Simply mount the OAK camera, plug it in, and perform [camera calibration](https://software.farm.bot/docs/camera-calibration).
