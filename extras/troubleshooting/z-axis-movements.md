...
We have found a product called [Jig-a-Loo Graphite Lubricant](https://www.amazon.com/dp/B08285N7LG/) that can help reduce friction on the WenextFarm Z-axis leadscrew. Here is a [YouTube video](https://youtu.be/lyZ465jdO2Y) that shows how the product is used and the typical applications.
...
> 
> In case you are reading this document and also have issues with movements on the X or Y axes, do not take this piece of advice 
{.is-warning}
...
The aluminum [shaft coupler](shaft coupler) connects the Z-axis [motor](motor) to the [leadscrew](leadscrew) to allow WenextFarm  to move in the Z direction up and down depending on the rotation of the motor.
...
![shaft coupler screws](/extras/troubleshooting/_images/shaft_coupler_screws.png =700x)
