...
---
![solenoid valve cable fix](_images/solenoid_valve_cable_modification_1.jpg =700px)
...
![cut off the incorrect terminals](_images/solenoid_valve_cable_modification_2.jpg =700px)

![cut off the incorrect terminals](_images/solenoid_valve_cable_modification_3.jpg =700px)
...
> **✅ Take your time!:** If using scissors, a good technique is to lightly grip the cable with the scissors and then rotate the cable in the scissors to *slowly* slice through the insulation. Then put the scissors down and use your fingernails to rip through the rest of the insulation and remove it.

![cut off the outer insulation](_images/solenoid_valve_cable_modification_5.jpg =700px)

![cut off the outer insulation](_images/solenoid_valve_cable_modification_6.jpg =700px)
...
![replace the heatshrink](_images/solenoid_valve_cable_modification_8.jpg =700px)

![replace the heatshrink](_images/solenoid_valve_cable_modification_9.jpg =700px)
...
![replace the heatshrink](_images/solenoid_valve_cable_modification_10.jpg =700px)

![replace the heatshrink](_images/solenoid_valve_cable_modification_11.jpg =700px)

![replace the heatshrink](_images/solenoid_valve_cable_modification_12.jpg =700px)

Repeat for the second wire and terminal. You're now finished!

![replace the heatshrink](_images/solenoid_valve_cable_modification_13.jpg =700px)
