...
The FarmBot comes equipped with a black plastic water [pressure regulator](pressure regulator). However, this component only regulates the water pressure _downstream_ of the [solenoid valve](solenoid valve). It does not regulate the pressure upstream of the valve.
