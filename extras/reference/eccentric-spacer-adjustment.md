...
> **Don't use force** 
> 
> If the wheel spacing is too small, do not force it on. Excessive force can cause a screw or plate to bend, introduce significant friction to the system, cause a wheel to deform, or induce other damage.
{.is-danger}


![gantry wheel plate fit test](/extras/reference/_images/gantry_wheel_plate_fit_test.png =700x)
...
![gantry wheel plate eccentric spacers loosest](/extras/reference/_images/gantry_wheel_plate_eccentric_spacers_loosest.png =700x)
![gantry wheel plate eccentric spacers](/extras/reference/_images/gantry_wheel_plate_eccentric_spacers.png =700x)
...
![cross-slide eccentric spacers loosest](_images/cross_slide_eccentric_spacers_loosest.png =700px)
![cross-slide eccentric spacers](_images/cross_slide_eccentric_spacers.png =700px)
...
![z-axis eccentric spacers loosest](/extras/reference/_images/z_axis_eccentric_spacers_loosest.png =700x)
![z-axis eccentric spacers](/extras/reference/_images/z_axis_eccentric_spacers.png =700x)

> **ℹ️ Need just a little more space?:** 
> 
> If the fit of the wheels on the extrusion is still too tight after adjusting all of the eccentric spacers to their loosest setting (`6mm` engraving facing away from the extrusion), you can increase the distance between the two sets of wheels slightly more by adjusting the wheels with standard spacers as well.
{.is-info}
