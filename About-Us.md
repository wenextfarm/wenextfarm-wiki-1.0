...
Local supply chain – All production is based in China, allowing us to source components directly from factories at competitive prices, and we pass those savings on to you.

Reinvestment, not dividends – Our goal has never been to profit quickly from an open‑source project. Instead, we want to bring future farming into every home. All profits are reinvested into product development, upgrades, and community support.

## Our Ambition
We are now exploring smaller‑scale, industrial‑grade automated farming solutions based on FarmBot’s gantry design. Our ultimate dream is to turn FarmBot into a household appliance – as common as a refrigerator or washing machine – installed in every home, producing fresh, pesticide‑free greens every day.
