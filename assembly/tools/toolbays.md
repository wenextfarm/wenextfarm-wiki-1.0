...
![3-slot toolbays](_images/3-slot_toolbays.jpg =700px)

> **ℹ️ 15 minutes:** This is the estimated time it will take to install both toolbays
...
> **✅ Within reach and squared up:** Ensure that you mount the tool bay in a location that FarmBot's UTM can get to. Keep in mind that the UTM needs to be able to slide tools **all the way into the bay**, **all the way out**, and be able to mount and dismount tools **from above**. Make sure you verify this for each of the tool bay's slots.
...
![toolbay mounted to bed](_images/toolbay_mounted_to_bed.jpg =700px)
![toolbay notch](_images/toolbay_notch.jpg =700px)

# Step 2: Repeat for the second toolbay

![both toolbays mounted to bed](_images/both_toolbays_mounted_to_bed.jpg =700px)

> **✅ Genesis XL kits also include three 1-slot toolbays:** Mount them using the same method used for the 3-slot toolbays.

> **ℹ️ Are the included toolbays not enough?:** If you are interested in using more tools and seed containers at once, you will need to purchase or make more toolbays. Check out our **[online shop](http://shop.farm.bot)** to purchase more.
...
![toolbays with tools](_images/toolbays_with_tools.jpg =700px)
