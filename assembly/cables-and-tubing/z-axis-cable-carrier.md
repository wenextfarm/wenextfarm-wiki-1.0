...
![Remove the tabs](_images/remove_z_tabs_1.png =700px)
![Remove the tabs](_images/remove_z_tabs_2.png =700px)
...
![Z cable carrier orientation (z-axis end)](_images/z_cable_carrier_orientation_1.png =700px)
![Z cable carrier orientation (cross-slide end)](_images/z_cable_carrier_orientation_2.png =700px)
...
> **ℹ️ Note:** The exact number of pins in each connector may vary from the images below depending on when your kit was manufactured.

![Cables and tube organization](_images/z_cable_carrier_organization_cross_slide_end.png =700px)
![Cables and tube organization](_images/z_cable_carrier_organization.png =700px)

> **✅ Organization is important!:** When laying the cables and tube in the cable carrier, ensure that none of the items criss-cross over each other. If they do, you will have trouble snapping in the tabs and you risk compressing the tube and preventing water flow.
...
![Snap in some tabs](_images/snap_in_some_z_cc_tabs.png =700px)
...
![Drape the cable carrier into position](_images/drape_z_cc.png =700px)
![Mount the cable carrier to the cross-slide](_images/mount_z_cc_to_cross_slide.png =700px)
...
![mount the cable carrier to the z-axis](_images/mount_the_cable_carrier_to_the_z-axis.png =700px)

# Step 6: Connect the z-axis motor and encoder

Feed the **ZZ motor and encoder cables** up through the slots in the [vertical cable carrier supports](vertical cable carrier supports), and then through the slot in the [z-axis motor mount](z-axis motor mount). Then connect the cables to the motor and encoder.

![Connect the z motor and encoder cables](_images/connect_z_motor_cables_1.png =700px)
![Connect the z motor and encoder cables](_images/connect_z_motor_cables_2.png =700px)

# Step 7: Add the vertical motor housing

Attach the [vertical motor housing](vertical motor housing) to the [z-axis extrusion](z-axis extrusion) using [M5 x 10mm screws](M5 x 10mm screws) and [tee nuts](tee nuts).

![Add the vertical motor housing](_images/add_vertical_motor_housing.png =700px)
...
![Snap in the remaining tabs](_images/snap_in_remaining_z_cc_tabs.png =700px)

> **⚠️ Not easy to adjust:** Once you snap-in the remaining tabs, it will become impossible to adjust anything without removing the majority of the tabs first. Make sure everything is in place before you make a bunch of extra work for yourself.
