...
![Remove the tabs](_images/remove_tabs_1.png =700px)
![Remove the tabs](_images/remove_tabs_2.png =700px)
...
![Lay out the x cable carrier](_images/lay_out_x_cable_carrier.png =700px)
...
![Add the water tube and power supply cable](_images/add_x_cc_contents.png =700px)

> **✅ Organization is important!:** When laying the cable and tube in the carrier, ensure that they do not criss-cross over each other. If they do, you will have trouble snapping in the tabs and you risk compressing the tube and preventing water flow.
...
![Snap in some tabs](_images/snap_in_some_x_cc_tabs.png =700px)
...
![Mount the x-axis cable carrier](_images/mount_x_cc_1.png =700px)
...
![Mount the x-axis cable carrier](_images/mount_x_cc_3.png =700px)

> **ℹ️ Does your mounting slot look different?:** Some kits shipped in August of 2022 included horizontal cable carrier supports that are 10mm wider than shown in the images above and feature a different slot. If your kit is like this, there should be **one more cable carrier support** in a small plastic bag (shown below) that has a narrower width and a slot compatible with your cable carrier.
...
![cable carrier support swap](_images/cc_support_swap.jpg =700px)
...
![Snap in the remaining tabs](_images/all_x_cc_tabs.png =700px)

> **⚠️ Not easy to adjust:** Once you snap-in the remaining tabs, it will become difficult to adjust the cable and tube without removing many of the tabs first. Make sure everything is in place before you make a bunch of extra work for yourself.
