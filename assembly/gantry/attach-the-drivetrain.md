...
![龙门架-点击装配.jpg](/assembly/gantry/_images/龙门架-点击装配.jpg)
...
> **Optionally use blue thread locker:** 
> 
...
![龙门架安装-1.jpg](/assembly/gantry/_images/龙门架安装-1.jpg =700x)
...
![龙门架安装-2.jpg](/assembly/gantry/_images/龙门架安装-2.jpg =700x)

![龙门架安装-3.jpg](/assembly/gantry/_images/龙门架安装-3.jpg =700x)


# Step 3: Secure the belts

Secure one end of the belt to the front end of the tracks by using a [belt clip], [belt sleeve], [20mm nut bar], and two [M5 x 10mm screws]. The belt must be wrapped through the clip as outlined in the [belt installation guide](../../extras/reference/belt-installation.md). Repeat for the other end of the belt on the other end of the tracks. Then repeat for the second x-axis belt on the other side of the WenextFarm. Trim or coil any extra belt, if desired.

![龙门架安装-4.jpg](/assembly/gantry/_images/龙门架安装-4.jpg =700x)
...
> **Congrats! 🎉:** 
> 
> You're now done building your WenextFarm's gantry.
{.is-success}
