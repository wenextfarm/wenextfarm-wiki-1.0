...
![motor in housing](_images/motor_in_housing.png =700px)
![both_gantry_motors_attached](_images/both_gantry_motors_attached.png =700px)
...
> **⚠️ Avoid twists:** When dropping the belt ends through the gantry column and feeding them along the tracks, ensure that there are no twists in the belt.

![belt around gantry motor pulley](_images/belt_around_gantry_motor_pulley.png =700px)
![belt fed through gantry wheels](_images/belt_fed_through_gantry_wheels.png =700px)
...
![x-axis belt secured](_images/x-axis_belt_secured.png =700px)
![x-axis belt both ends secured](_images/x-axis_belt_both_ends_secured.png =700px)

# Step 4: Equalize the gantry

> **ℹ️ Note:** An **equalized gantry** is one that is exactly _perpendicular_ to the **tracks**.
...
> **✅ Congrats! 🎉:** You're now done building your FarmBot's gantry.
